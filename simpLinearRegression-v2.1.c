...
/* Jan Klingel, 06/2025                                             */
/* Version 2, using a struct for the trainings data                 */
...
int main(void) {
  unsigned int n, i;
  int pprice; // predicted price
  int squaref; // square footage of given house
  float r,sx,sy,a,b = 0.0; // correlation, standard deviation, coefficient a,b
  float xbar, ybar; // means of all x and y values

  // Reserve memory for the trainings data struct and initialize
  struct trainingsData td = {{316000,277000,155000,253000,211000,329000,
